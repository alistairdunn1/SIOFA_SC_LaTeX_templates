...
%   except for the check boxes for Document Type and Distribution
% Useage: 
%   1. ReportProporties.tex to enter the meeting, report title, author, report numbers, etc.
%   2. ReportAbstract.tex to enter the abstract
%   3. ReportRecomendations.tex to enter the recomendations
...
\begin{document}
  ...
  \begin{table}[H]
    \begin{tabular}{|m{4cm}|m{11cm}|}
      \hline
       % Use \CheckBoxTick OR CheckBoxUntick
      ...
      \hline
      % Abstract
      \multicolumn{2}{|l|}{\input{ReportAbstract.tex}} \\
      \hline
    \end{tabular}%
  \end{table}
  ...
  \begin{table}[H]
    \begin{tabular}{|p{15cm}|}
      ...
      \hline
      % Add the recomendations to the file Recomendations.tex
      \input{ReportRecomendations.tex} \\
      \hline
    \end{tabular}%
  \end{table}

  \newpage
  % The report text can be inserted into the file Report.tex
